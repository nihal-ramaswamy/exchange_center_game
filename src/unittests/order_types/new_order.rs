...
use crate::dto::{order_helper::order_core::OrderCore, order_types::new_order::NewOrder};

#[test]
fn test_equality_when_order_core_equal() {
    let order_core = OrderCore::new("username".to_string(), "order_id".to_string(), "security_id".to_string());
...
fn test_equality_when_order_core_not_equal() {
    let order_core1 = OrderCore::new("username".to_string(), "order_id".to_string(), "security_id".to_string());
    let order_core2 = OrderCore::new("username1".to_string(), "order_id".to_string(), "security_id".to_string());
